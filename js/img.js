(function() {
	...
	moveImg.prototype = {
		...
		loadImg: function() {
            ...
            // setTimeout(function(){
            //
				// var parentID=document.getElementById("imgbox");
		...
		creatLi: function(w, h, row, col, src) {
			...
			li.style.border = "1px solid #f39800";
		...
		_start: function(evt) {
			...
			console.log(this.tochEvent.tagName);
			if(this.tochEvent.tagName == "LI") {
		...
		_move: function(evt) {
			...
			if(this.tochEvent.tagName == "LI" && this.tochEvent.childNodes[0].tagName == "IMG" && this.tochEvent.childNodes[0].getAttribute("src") != "null" && this.tochEvent.childNodes[0].getAttribute("src") != "" && this.tochEvent.childNodes[0].getAttribute("src") != "undefined") {
		...
		_end: function(evt) {
			if(this.tochEvent.tagName == "LI" && this.tochEvent.childNodes[0].tagName == "IMG" && this.tochEvent.childNodes[0].getAttribute("src") != "null" && this.tochEvent.childNodes[0].getAttribute("src") != "" && this.tochEvent.childNodes[0].getAttribute("src") != "undefined") {
				...
				//console.log(oldEl.positionList)
